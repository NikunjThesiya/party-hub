...
const SpecialMoment = () => {
	return (
		<div className="w-full bg-theme-white flex flex-col items-center gap-12 pb-12">
			<div className="min-h-[150px] lg:min-h-[300px] w-full overflow-hidden">
			...
			<div className="main-container w-full flex flex-col items-center gap-4 text-center">
				<SectionHeading
					...
					summary={
						<>
							We’re all about bringing joy, fun, and a personal touch to every
							occasion, making sure your special moments
							<br className="lg:block hidden" /> are truly unforgettable.
						</>
					}
				/>
